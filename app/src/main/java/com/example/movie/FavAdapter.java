...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.ViewHolder> {
  ...
  //  private DatabaseReference refLike;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_movie_details,
                parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            favTextView = itemView.findViewById(R.id.titel);
            favBtn = itemView.findViewById(R.id.fab_favorites);
            favImageView = itemView.findViewById(R.id.posterimage);
